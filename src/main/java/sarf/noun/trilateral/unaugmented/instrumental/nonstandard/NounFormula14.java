...
public class NounFormula14 extends NonStandardInstrumentalNounFormula{
    ...
    public NounFormula14(UnaugmentedTrilateralRoot root, String suffixNo, GenericNounSuffixContainer genericNounSuffixContainer) {
    ...
    public String form() {
        ...
        case 13:
        case 15:
            return "إ"+ArabCharUtil.KASRA+root.getC1()+ArabCharUtil.SKOON+root.getC2()+ArabCharUtil.KASRA+"ي"+root.getC3()+suffix;
        }
