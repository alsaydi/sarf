...
public class NounFormula12 extends NonStandardInstrumentalNounFormula{
    ...
    public NounFormula12(UnaugmentedTrilateralRoot root, String suffixNo, GenericNounSuffixContainer genericNounSuffixContainer) {
    ...
    public String form() {
        if (suffixNo % 2 == 0)
            return root.getC1()+ArabCharUtil.DAMMA+root.getC2()+ArabCharUtil.FATHA+"ا"+root.getC3()+suffix;
        return "";
    }
