...
public class NounFormula12 extends AugmentedTrilateralNoun {
    public NounFormula12(AugmentedTrilateralRoot root, String suffix, GenericNounSuffixContainer genericNounSuffixContainer) {
     ...
     */
    public String form() {
        return "م"+ArabCharUtil.DAMMA+root.getC1()+ArabCharUtil.SKOON+root.getC2()+ArabCharUtil.FATHA+"ا"+root.getC3()+ArabCharUtil.KASRA+ root.getC3()+suffix;
    }
}
