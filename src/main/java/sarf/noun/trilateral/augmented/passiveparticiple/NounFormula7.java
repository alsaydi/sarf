...
public class NounFormula7 extends AugmentedTrilateralNoun {
    public NounFormula7(AugmentedTrilateralRoot root, String suffix, GenericNounSuffixContainer genericNounSuffixContainer) {
     ...
     */
    public String form() {
        return "م"+ArabCharUtil.DAMMA+"ت"+ArabCharUtil.FATHA+root.getC1()+ArabCharUtil.FATHA+"ا"+root.getC2()+ArabCharUtil.FATHA+root.getC3()+suffix;
    }
}
