...
public class GerundSelectionUI extends JPanel implements IControlPane, TrilateralAugmentedGerundConjugatorListener, QuadriliteralUnaugmentedGerundConjugatorListener, AugmentedTrilateralModifierListener {
    ...
    ToggleRenderedButton standardBtn = new ToggleRenderedButton("المصدر الأصلي");
    ToggleRenderedButton nomenBtn = new ToggleRenderedButton("مصدر المرة");
    ToggleRenderedButton meemBtn = new ToggleRenderedButton("المصدر الميمي ");
