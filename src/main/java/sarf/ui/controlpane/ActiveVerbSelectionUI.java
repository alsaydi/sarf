...
public class ActiveVerbSelectionUI extends JPanel implements IControlPane, AugmentedTrilateralModifierListener {
    ...
    ToggleRenderedButton pastBtn = new ToggleRenderedButton("الماضي");
    ToggleRenderedButton presentNominativeBtn = new ToggleRenderedButton("المضارع المرفوع");
    ToggleRenderedButton presentAccusativeBtn = new ToggleRenderedButton("المضارع المنصوب");
    ToggleRenderedButton presentJussiveBtn = new ToggleRenderedButton("المضارع المجزوم");
    ToggleRenderedButton presentEmphasizedBtn = new ToggleRenderedButton("المضارع المؤكد");
    ToggleRenderedButton imperativeBtn = new ToggleRenderedButton("الأمر");
    ToggleRenderedButton imperativeEmphasizedBtn = new ToggleRenderedButton("الأمر المؤكد");
