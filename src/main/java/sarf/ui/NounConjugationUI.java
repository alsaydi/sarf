...
public class NounConjugationUI extends APanel implements NounStateSelectionUIListener ,IHtmlContentSaver {
    ...
    public NounConjugationUI(IMainControlPanel controlPaneContainer, sarf.Action sarfAction, INounSuffixContainer nounSuffixContainer, String title) {
        ...
        rightPane.add(decorateLabel(new JLabel("الرفع")));
        rightPane.add(decorateLabel(new JLabel("النصب")));
        rightPane.add(decorateLabel(new JLabel("الجر")));

        headerPane.add(decorateLabel(new JLabel()));
        headerPane.add(decorateLabel(new JLabel("مذكر")));
        headerPane.add(decorateLabel(new JLabel("مؤنث")));
    ...
    class StatePanel extends JPanel {
        ...
        StatePanel(boolean isHeader) {
            ...
            add(decoratePronounLabel(new JLabel("مفرد")));
            ...
            add(decoratePronounLabel(new JLabel("مثنى")));
            ...
            add(decoratePronounLabel(new JLabel("جمع")));
