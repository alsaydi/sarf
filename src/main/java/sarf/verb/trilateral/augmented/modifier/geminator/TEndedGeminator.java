...
public class TEndedGeminator extends SubstitutionsApplier implements IAugmentedTrilateralModifier {
    ...
    public boolean isApplied(ConjugationResult conjugationResult) {
        ...
        switch (formulaNo) {
            ...
            case 10:
            case 11:
                if (kov == 1 || kov == KindOfVerb.Mudaaf || kov == KindOfVerb.Mahmouz_Faa_Mudaaf || kov == KindOfVerb.Mahmouz_Faa || kov == KindOfVerb.Mahmouz_Ain || kov == KindOfVerb.Mithal_Wawi || kov == KindOfVerb.Ajwaf_Wawi || kov == KindOfVerb.Ajwaf_Yaee) {
                    return true;
                }
        }
        return false;
