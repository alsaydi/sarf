...
public class NounFormula1 extends AugmentedQuadriliteralNoun {
     ...
     */
    public String form() {
        return "م"+ArabCharUtil.DAMMA+"ت"+ArabCharUtil.FATHA+root.getC1()+ArabCharUtil.FATHA+root.getC2()+ArabCharUtil.SKOON+root.getC3()+ArabCharUtil.FATHA+root.getC4()+suffix;
    }
}
