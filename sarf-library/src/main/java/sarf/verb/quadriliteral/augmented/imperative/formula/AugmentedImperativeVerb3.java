...
public class AugmentedImperativeVerb3 extends AugmentedImperativeVerb {
    ...
    public String form() {
        return "ا"+root.getC1()+ArabCharUtil.SKOON+root.getC2()+ArabCharUtil.FATHA+root.getC3()+ArabCharUtil.SKOON+root.getC4()+ArabCharUtil.KASRA+root.getC4()+lastDim+connectedPronoun;
    }
}
