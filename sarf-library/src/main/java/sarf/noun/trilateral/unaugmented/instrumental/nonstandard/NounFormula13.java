...
public class NounFormula13 extends NonStandardInstrumentalNounFormula{
    ...
    public NounFormula13(UnaugmentedTrilateralRoot root, String suffixNo, GenericNounSuffixContainer genericNounSuffixContainer) {
    ...
    public String form() {
        ...
        case 14:
        case 16:
            return "أ" + ArabCharUtil.DAMMA + root.getC1() + ArabCharUtil.SKOON + root.getC2() + ArabCharUtil.DAMMA + "و" + root.getC3() + suffix;
        }
        return "";
    }
